  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      providers: [
        ...
        ChangeNotifierProvider(
          create: (context) => OtpPageProvider(),
        ),
        ChangeNotifierProvider(
          create: (context) => LoginProvider(),
        ),
        ChangeNotifierProvider(
          create: (context) => OwnerSignUpProvider(),
        ),
        ChangeNotifierProvider(
          create: (context) => OwnerOtpProvider(),
        ),
        ChangeNotifierProvider(
          create: (context) => OwnerLoginPageProvider(),
        ),
        ChangeNotifierProvider(
        ...
        ChangeNotifierProvider(
          create: (context) => AddShowProvider(),
        ),
        ChangeNotifierProvider(
          create: (context) => MoviesProvider(),
        ),
        ChangeNotifierProvider(
          create: (context) => FireBaseFunctionProvider(),
        ),
        ChangeNotifierProvider(
        ...
        ChangeNotifierProvider(
          create: (context) => TheatreShowingController(),
        ),
        ChangeNotifierProvider(
          create: (context) => RazorPayController(),
        )
      ],
      child: MaterialApp(
